package com.jucelio.beberagua_lembrete
...
import com.jucelio.beberagua_lembrete.model.CalcularIngestaoDiaria
...
class MainActivity : AppCompatActivity() {
    ...
    binding.btDefinirLembrete .setOnClickListener
    {
        ...
        timePickerDialog = TimePickerDialog(this, { timePicker: TimePicker, hourOfDay: Int,
                                                    minutes: Int ->
    ...
    binding.btAlarme.setOnClickListener
    {
        ...
        if (!txt_hora.txtHora.toString().isEmpty() && !txt_minutos.txtMinutos.toString()
                .isEmpty()
        ) {
